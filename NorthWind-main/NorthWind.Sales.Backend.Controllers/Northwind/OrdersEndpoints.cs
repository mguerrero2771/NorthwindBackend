...
public static class OrdersEndpoints
{
    ...
    public record PagedQuery(string? customerId, int page = 1, int pageSize = 20);
    ...
    private static async Task<IResult> List([AsParameters] PagedQuery query, INorthWindSalesQueriesDataContext db)
    {
        ...
        var items = await q.OrderByDescending(o => o.Id)
                           ...
                           .Select(o => new OrderDto(o.Id, o.CustomerId, o.OrderDate, o.ShipAddress, o.ShipCity, o.ShipCountry, o.ShipPostalCode))
                           .ToListAsync();
