...
internal class UserLoginViewModelDtoValidator(
 IModelValidatorHub<UserCredentialsDto> validator) :
    AbstractViewModelValidator<UserCredentialsDto, UserLoginViewModel>(
